describe('Test Suite - Login with user: Store leader and  / Store Manager (Director de tienda)', () => {
  ...
  it('should visit a page and assert on its content', () => {
    ...
    cy.wait(1000)
    cy.log('Login with Store leader and  / Store Manager (Director de tienda) ');
