describe('Test Suite - Login with user: RS (Store Manager"Store leader"), Store Organizer and Coach leader', () => {
  ...
  before(function () {
    ...
    it('passes with cy.origin()', () => { 
      ...
      cy.get("#username").should("be.visible").type(data.Users.username_LD_DT)
      cy.get("#password").should("be.visible").type(data.Users.password_5)
      ...
      cy.wait(2000)
      cy.log('User RS (Store Manager"Store leader"), Store Organizer and Coach leader (Centro MX1610)');
