...
describe('Test Suite - re-entry processes with user: GP ', () => {
  ...
  it('passes with cy.origin()', () => {
    ...
    cy.origin('https://qa-mex.decathlon.net/e2-mx-front/develop/map', { args: { colaboradorReingreso } }, ({ colaboradorReingreso }) => {
      ...
      cy.get('[href="/e2-mx-front/develop/mx/MX1982/rehiring/rehiringProcesses"] > .dropdown-item')
      ...
      cy.get('#app > div > div > div.open-processes_searchBox_TPDNA > div > div')
        .should("be.visible")
        .click()
        .type(colaboradorReingreso.reingreso.filtro)
      cy.wait(2000)
      ...
      cy.log('User GP re-entry processes. (Centro MX1982)');
