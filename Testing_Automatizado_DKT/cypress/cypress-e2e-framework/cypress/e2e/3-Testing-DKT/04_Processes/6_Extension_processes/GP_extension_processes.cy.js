...
describe('Test Suite - extension processes with user: GP ', () => {
  ...
  before(function () {
    cy.fixture('new_users_1').then(function (loginData) {
      ...
      cy.fixture('procesosdeextension').then(function (colaboradorextension) {
        globalThis.colaboradorextension = colaboradorextension
  ...
  it('passes with cy.origin()', () => {
    ...
    cy.viewport(1450, 850)
    cy.origin('https://qa-mex.decathlon.net/e2-mx-front/develop/map', { args: { colaboradorextension } }, ({ colaboradorextension }) => {
      ...
      cy.get('[href="/e2-mx-front/develop/mx/MX1982/extensions"] > .dropdown-item')
      ...
      cy.get('#app > div > div > div.collaborator-extension-list_searchBox_X4Ke4 > div > div')
        .should("be.visible")
        .click()
        .type(colaboradorextension.extension.filtro)
      cy.wait(2000)
      ...
      cy.log('User GP extension processes. (Centro MX1982)');
