...
describe('Test Suite - Home Director/a y RH with user: DZ (Zone Director)', () => {
  ...
  it('passes with cy.origin()', () => {
    ...
    cy.origin('https://qa-mex.decathlon.net/e2-mx-front/develop/map', { args: { colaboradorData } }, ({ colaboradorData }) => {
      ...
      //Expaind
      cy.get("#app > div > div > div:nth-child(1) > div > div.el-table--fit.el-table--scrollable-x.el-table--scrollable-y.el-table--enable-row-hover.el-table--enable-row-transition.el-table.el-table--layout-fixed.is-scrolling-left > div.el-table__inner-wrapper > div.el-table__body-wrapper > div > div.el-scrollbar__wrap.el-scrollbar__wrap--hidden-default > div > table > tbody > tr:nth-child(1) > td.el-table_2_column_4.el-table__expand-column.el-table__cell > div > div > i > svg")
      ...
      cy.log('User DZ (Zone Director) Home Director/a y RH. (Centro MX1982)');
