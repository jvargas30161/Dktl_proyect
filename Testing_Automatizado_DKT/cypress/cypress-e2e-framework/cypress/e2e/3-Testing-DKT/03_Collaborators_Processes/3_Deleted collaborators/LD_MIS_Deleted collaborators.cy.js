...
describe('Test Suite - Deleted collaborators with user: LD_MIS ', () => {
  ...
  it('Cross Domain', () => {
    ...
    cy.origin('https://qa-mex.decathlon.net/e2-mx-front/develop/map', { args: { colaboradorData, colaboradorDeleted } }, ({ colaboradorData, colaboradorDeleted }) => {
      ...
      cy.get('[href="/e2-mx-front/develop/mx/MX1610/collaborators/deletedCollaborators"] > .dropdown-item').should("be.visible").click()
      cy.wait(1000)
      ...
      cy.get('#deletedAdvancedFilters > div:nth-child(1) > div:nth-child(2) > div > div > div > div')
        ...
        .type(colaboradorDeleted.fechaDeBaja.rfc1610)
      cy.wait(5000)
      cy.get('.el-button > span')
        .click()
      cy.wait(5000)

      cy.get('.el-table__row > .el-table_6_column_30 > .cell')
        .should("be.visible")
        .click()
      cy.wait(5000)
      ...
      cy.log('User LD_MIS Collaborators (Centro MX1610)');
